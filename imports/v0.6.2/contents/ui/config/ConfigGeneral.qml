...
Kirigami.FormLayout {
 ...
 Controls.SpinBox { id:rowHeight; Kirigami.FormData.label:page.ru?"Высота строки:":"Row height:"; from:64; to:160; editable:true; textFromValue:function(v){return v+" px"}; valueFromText:function(t){return parseInt(t)} }
 ...
 Controls.SpinBox { id:fadeWidth; enabled:edgeFade.value>0; Kirigami.FormData.label:page.ru?"Ширина перехода:":"Fade width:"; from:1; to:96; editable:true; textFromValue:function(v){return v+" px"}; valueFromText:function(t){return parseInt(t)} }
